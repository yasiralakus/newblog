...

                {
                    ...
                    <div>
                        <div className="blog-page-left-item">
                            ...
                            <div>
                                <Link>Alonso, 'zorlu' Imola haftasonunu 19. sırada tamamladıktan sonra Monaco'ya geri dönmeye istekli.</Link>
                        ...
                        <div className="blog-page-left-item">
                            ...
                            <div>
                                <Link>Vasseur, Ferrari'nin kendi evinde Imola zaferi şansını nerede kaybettiğini tespit ederken 'biraz hayal kırıklığına uğradı'.</Link>
                        ...
                        <div className="blog-page-left-item">
                            ...
                            <div>
                                <Link>Imola'dan 6 Kazanan ve 5 Kaybeden – F1 Avrupa'ya dönerken kim başarılı oldu?</Link>
                        ...
                        <div className="blog-page-left-item">
                            ...
                            <div>
                                <Link>Vettel: "F1'i bazen özlüyorum ama kararımdan memnunum".</Link>
                        ...
                        <div className="blog-page-left-item">
                            ...
                            <div>
                                <Link>Sainz: "Leclerc'in temposu ön taraf mücadelesinde olduğumuzun bir kanıtı".</Link>
                        ...
                        <div className="blog-page-left-item">
                            ...
                            <div>
                                <Link>Williams, Bottas'la mı ilgileniyor?</Link>
...

                {
                    ...
                    <div>
                        <div className="blog-page-left-item">
                            ...
                            <div>
                                <Link>Sauber, yeni donanım sayesinde "kritik bir soruna" çözüm getirmeye hazırlanıyor.</Link>
                        ...
                        <div className="blog-page-left-item">
                            ...
                            <div>
                                <Link>Piastri: "McLaren artık hangi piste giderse gitsin kendisine güvenebilir".</Link>
                        ...
                        <div className="blog-page-left-item">
                            ...
                            <div>
                                <Link>Tsunoda: "Mükemmel bir yarış geçirseydim daha da yukarıda olabilirdim".</Link>
